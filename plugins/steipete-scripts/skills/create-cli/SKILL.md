...
attribution: "Peter Steinberger (@steipete) — https://github.com/steipete/agent-scripts"
---
...
> *Skill ported from [steipete/agent-scripts](https://github.com/steipete/agent-scripts) by Peter Steinberger (@steipete).*
