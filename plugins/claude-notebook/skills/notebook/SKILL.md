...
Instantiate from `00 System management/00.03 Templates for the system/claude-notebook/D00-09 System/D03 LLMs & agents/Agent session.md` (relative to the `00-09 System/` area root). Substitute placeholders:
